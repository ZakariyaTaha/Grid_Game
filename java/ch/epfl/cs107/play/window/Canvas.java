...
public interface Canvas extends Positionable {
	 ...
	 * @param removeBackground (boolean): which indicate if we need to remove an
	 *                         uniform background
	 ...
	 * @param depth     (float): any real, larger values are drawn afterward, i.e.
	 *                  above
	 */
	 ...
	 * @param alpha        (float): transparency, between 0.0 and 1.0
	 * @param depth        (float): any real, larger values are drawn afterward,
	 *                     i.e. above
	 */
	 ...
	 * @param hAlign       (TextAlign.Horizontal): horizontal alignment of the text
	 *                     around the anchor vector
	 * @param vAlign       (TextAlign.Vertical): vertical alignment of the text
	 *                     around the anchor vector
