...
public final class SwingImage implements Image {
	 ...
	 * @param roi              (RegionOfInterest): rectangle of interest in the
	 *                         image, may be null
	 * @param removeBackground (boolean): which indicate if need to remove an
	 *                         uniform background
	 */
	...
	/**
	 * Remove uniform background from an image, putting full alpha instead. Useful
	 * to integrate Sprite which are given with uniform background color Assume
	 * background color is contained into the top left corner
	 */
