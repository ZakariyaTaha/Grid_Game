...
public final class TextItem implements Item {
	...
	public TextItem(String text, float fontSize, Transform transform, Color fillColor, Color outlineColor,
			...
			TextAlign.Vertical vAlign, float depth, float alpha) {
		this.text = text;
	...
	public void render(Graphics2D g) {
		...
		final AffineTransform a = new AffineTransform(transform.m00, transform.m10, transform.m01, -transform.m11,
				transform.m02 + transform.m01, transform.m12 + transform.m10);

		// Define intrinsic text properties
		g.setFont(font);
