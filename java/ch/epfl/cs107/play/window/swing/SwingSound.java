...
public final class SwingSound implements Sound {
	...
	/**
	 * Default SwingSound Constructor - store the input stream into an audio byte
	 * array - keep also format, info and size in memory
	 * 
	 * @param input (InputStream): corresponding to the sound file. Not null
	 * @throws IOException                   : if the AudioInputStream cannot be
	 *                                       read
	 ...
	 * 
	 * @param offset (int): the point at which to start copying, expressed in bytes
