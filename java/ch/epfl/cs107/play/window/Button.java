...
public final class Button implements Serializable {
	 ...
	 * @param isLastPressed (boolean): indicate if the button is the last button
	 *                      pressed
	 */
	...
	/**
	 * @return (boolean): whether the button was released, regardless of current
	 *         state
	 */
	...
	/**
	 * @return (boolean): whether the button was pressed, regardless of current
	 *         state
	 */
