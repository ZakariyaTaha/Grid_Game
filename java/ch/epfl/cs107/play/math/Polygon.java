...
public final class Polygon extends Shape {
	 ...
	 * Creates a new polygon.
	 * 
	 * @param points (Array of float): sequence of vertices (x1, y1, x2, y2, etc.),
	 *               not null
	 */
	...
	private void initialize() {
		...
		// TODO use better convex partitioning, i.e. split in convex polygons instead of
		// only triangles
	...
	public Path2D toPath() {
		// TODO is it possible to cache this? need to check if SwingWindow modifies
		// it...
