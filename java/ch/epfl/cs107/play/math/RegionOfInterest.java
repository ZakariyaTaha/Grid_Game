...
/**
 * Represents an immutable RegionOfInterest (RoI) in Image. A RegionOfInterest
 * is a rectangle defined by its top left corner and either dimension (width and
 * height) or bottom right corner
 */
public final class RegionOfInterest implements Serializable {
	 ...
	 * @return (RegionOfInterest): build a RegionOfInterest using the bottom right
	 *         corner instead of the dimensions
	 */
