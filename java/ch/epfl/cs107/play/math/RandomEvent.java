...
/**
 * Random Event implement notion of Bernoulli experiment with probability p of
 * success
 */
public final class RandomEvent extends Random {

	// Probability of success of the Bernoulli experiment
	private final float p;
	// Indicate if the experiment already happened at least once
	private boolean happened;
	// Indicate if the experiment can happen only once (i.e always fails after first
	// success)
	private final boolean onlyOnce;

	/**
	 * Default Bernoulli Experiment Constructor Notice: by default the event can
	...
	/**
	 * Random Constructor for Bernoulli experiment (i.e p is selected randomly)
