...
public class TextGraphics extends Node implements Attachable, Graphics {
	...
	public TextGraphics(String text, float fontSize, Color fillColor, Color outlineColor, float thickness, boolean bold,
			boolean italics, Vector anchor, TextAlign.Horizontal hAlign, TextAlign.Vertical vAlign, float alpha,
			float depth) {
		if (text == null)
	...
	public TextGraphics(String text, float fontSize, Color fillColor, Color outlineColor, float thickness, boolean bold,
		...
		this(text, fontSize, fillColor, outlineColor, thickness, bold, italics, anchor, TextAlign.Horizontal.LEFT,
				TextAlign.Vertical.BOTTOM, 1.0f, 0.0f);
	}
