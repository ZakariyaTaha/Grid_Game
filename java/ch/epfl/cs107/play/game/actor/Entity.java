...
public abstract class Entity implements Actor {
	...
	/**
	 * Update the current position (i.e. after motion) after position change, the
	 * transform need to be updated to. Hence set it to null
	 * 
	...
	public Transform getTransform() {
		...
		if (transform == null) {
			...
			transform = new Transform(1, 0, x, 0, 1, y);
		}
		return transform;
	}
