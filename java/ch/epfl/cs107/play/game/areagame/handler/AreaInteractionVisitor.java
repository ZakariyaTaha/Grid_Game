...
public interface AreaInteractionVisitor {
	...
	/**
	 * Default interaction between something and an interactable Notice: if this
	 * method is used, then you probably forget to cast the AreaInteractionVisitor
	 * into its correct child
	 * 
	 * @param other (Interactable): interactable to interact with, not null
	 */
	default void interactWith(Interactable other) {
		System.out.println("Warning: a Specific Interaction involving " + other.toString()
