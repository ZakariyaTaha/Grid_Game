...
/**
 * Text entity, can be used as actor. Can be put and aligned inside a cell .
 */
public class Text extends Entity {
	...
	/// Define if the text is relative to the world (false) or to the window (true),
	/// i.e. is the text always fixed in the window
	 ...
	 * @param position         (DiscreteCoordinates): Initial position in the grid,
	 *                         not null
	 * @param area             (Area): Area context of the text, not null
	 * @param isScreenRelative (boolean): indicate if the text is relative to the
	 *                         world or the window
	 ...
	 * @param hAlign           (Horizontal): Which horizontal alignment has the
	 *                         text, not null
	 * @param vAlign           (Vertical): Which vertical alignment has the text,
	 *                         not null
	 * @param alpha            (float): transparency of the text (0 is full
	 *                         invisible and 1 is full opaque)
	 * @param depth            (float): the depth of the text, small depth draw
	 *                         first
	 */
	public Text(String text, DiscreteCoordinates position, Area area, boolean isScreenRelative, float fontSize,
			Color color, boolean bold, boolean italics, TextAlign.Horizontal hAlign, TextAlign.Vertical vAlign,
		...
		this.textGraphics = new TextGraphics(text, fontSize, color, null, 0.0f, bold, italics, new Vector(x, y), hAlign,
				vAlign, alpha, depth);
	 ...
	 */
	public Text(String text, DiscreteCoordinates position, Area area, boolean isScreenRelative, float fontSize,
			Color color, boolean bold, boolean italics) {
		this(text, position, area, isScreenRelative, fontSize, color, bold, italics, TextAlign.Horizontal.LEFT,
				TextAlign.Vertical.BOTTOM, 1, 10);
	}
	...
	public Text(String text, DiscreteCoordinates position, Area area, boolean isScreenRelative, float fontSize,
		...
		this(text, position, area, isScreenRelative, fontSize, color, false, false, TextAlign.Horizontal.LEFT,
				TextAlign.Vertical.BOTTOM, alpha, depth);
	}
