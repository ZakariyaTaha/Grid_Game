...
public class Sprite extends ImageGraphics {
	 ...
	 * @param roi             (RegionOfInterest): region of interest into the image
	 *                        as a rectangle in the image. May be null
	 * @param anchor          (Vector): image anchor, not null
	 * @param alpha           (float): transparency, between 0 (invisible) and 1
	 *                        (opaque)
	 * @param depthCorrection (float): correction of the deepness defined by the
	 ...
	 * @param height (int): actual image height, before transformation
	 * @param parent (Positionable): parent of this, not null
	 * @param roi    (RegionOfInterest): region of interest into the image as a
