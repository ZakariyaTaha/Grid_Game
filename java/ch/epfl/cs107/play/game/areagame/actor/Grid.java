...
/**
 * Grid Overlay entity Draw a grid on the DiscreteCoordinate Lines: Assume a
 * coordinate system which is graduated every unit (0, 1, 2, ...) Assume a grid
 * overlay with unit square
 */
