...
public class PressureSwitch extends Switchable {
	...
	public PressureSwitch(Area area, DiscreteCoordinates coordinates) {
		super(area, Orientation.DOWN, coordinates);
		sprite = new Sprite("GroundLightOff", 1, 1.f, this);

	}

	public PressureSwitch(Area area, Orientation orientation, DiscreteCoordinates coordinates) {
